                ...
                <div className="row">
                    ...
                    <div className="col-md-6">
                        <div className="profile-head">
                                    ...
                                    <p className="proile-rating">RANKINGS : <span>{id}/10</span></p>
                ...
                <div className="row">
                     <div className="col-md-4">
                        <div className="profile-work">
                            <p>ADDRESS</p>
                           <a href="">City: {address.city}</a><br/>
                           <a href="">Street: {address.street}</a><br/>
                            <a href="">Building: {address.suite}</a><br/>
                            <a href="">Zip Code: {address.zipcode}</a>
                            <p>COMPANY</p>
                            <a href="">Name: {company.name}</a><br/>
                            <a href="">Phrase: {company.catchPhrase}</a><br/>
                            <a href="">Motto: {company.bs}</a><br/>
                            <a href="">Website: {user.website}</a><br/>                         
                        </div>
                    </div> 
